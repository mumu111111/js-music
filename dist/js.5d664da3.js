...
var Swiper = function Swiper(node) {
    ...
    var eventHub = { 'swipLeft': [], 'swipRight': [] };
...
var Player = function () {
    ...
    _createClass(Player, [{
        ...
        value: function loadSong() {
            ...
            var songObj = this.songList[this.currentIndex]; //获取当前第一个song
        ...
        value: function setLyrics(lyrics) {
            ...
            var fragment = document.createDocumentFragment(); //虚拟dom
            var lyricsArr = [];
        ...
        value: function playSong() {
            ...
            this.audio.oncanplaythrought = function () {
        ...
        value: function bind() {
            ...
            var self = this; //为了确保是一个this
            this.$('.btn-play-pause').onclick = function () {
                //点击暂停按钮 改变状态和类名样式为pause
...
},{"./icons.js":10,"./swiper.js":11}],14:[function(require,module,exports) {
...
//# sourceMappingURL=/js.5d664da3.map